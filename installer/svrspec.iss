...
; AppVersion comes from the package, via a file generated by
; installer/setup_cxfreeze.py. Hardcoding it here meant a third version to bump
; by hand, and it went stale at 0.2.7 -- the release workflow compares the tag
; against svrspec.__version__ and never looked at this script. Build the payload
; before compiling this, which both CI and the local build already do.
#include "version.iss"
